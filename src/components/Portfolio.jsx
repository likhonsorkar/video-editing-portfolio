    ...
    <section id="portfolio" className="py-28 md:py-36">
      <div className="max-w-6xl mx-auto px-6">
        <Reveal className="text-center max-w-2xl mx-auto mb-4">
          <span className="text-xs font-mono tracking-[0.2em] uppercase text-blue-soft">Featured Projects</span>
            ...
            {filtered.map((project, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-display font-semibold text-lg text-ink mb-1">{project.title}</h3>
      ...
      {/* Video Modal — 16:9 responsive Google Drive embed */}
      <AnimatePresence>
        {activeProject && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="p-5 flex items-center justify-between gap-4">
                <div className="min-w-0">
                  <h3 className="font-display font-semibold text-ink truncate">{activeProject.title}</h3>
                  <p className="text-sm text-ink-soft">{activeProject.role}</p>
                </div>
                <div className="flex items-center gap-2 shrink-0">
                  <a
                    ...
                    className="w-9 h-9 rounded-full border border-blue-line flex items-center justify-center text-ink-soft hover:text-blue-soft hover:border-blue-soft transition-colors touch-manipulation"
                    aria-label="Open in Google Drive"
                    title="Open in Google Drive — use this if the video doesn't play here"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveProject(null)}
                    className="w-9 h-9 rounded-full border border-blue-line flex items-center justify-center text-ink-soft hover:bg-canvas transition-colors touch-manipulation"
